					...
					<div class="col-xs-12">
						<div class="row">
							<form enctype="multipart/form-data" id="formulario" action="javascript:guardarEncuesta();" method="POST">
								...
								<div class="row">
									<div class="col-xs-12">
										<h3><strong>Editar Campaña</strong></h3>
										<br><br>
										<div class="row">
								...
								<div class="row">
										<div class="col-lg-3 col-md-3 col-xs-12">
											<div class="form-group">
												<label for="inicio">Inicio del Evento:</label><span style="color: red; font-size: 14px;">*</span>
										...
										<div class="modal-content">
											<div class="modal-body">
												<center>
													...
													<p>
														Tu campaña se ha editado exitosamente.
													</p>
												</center>
											</div>
											<div class="modal-footer">
										...
										<div class="modal-content">
											<div class="modal-body">
												<center>
													...
													<p>
														Hubo un problema al editar tu campaña.
													</p>
												</center>
											</div>
											<div class="modal-footer">
